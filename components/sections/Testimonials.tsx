const testimonials = [
  {
    quote:  'The service excellence programme transformed how our front desk team handles guest interactions. Guest satisfaction scores improved noticeably within the first month.',
    name:   'Hotel Manager',
  ...
  {
    quote:  'What sets HOREN apart is that their trainers have actually worked in hotels. The team building session with our department heads was the most effective we\'ve ever run.',
    name:   'General Manager',
    org:    'Boutique resort, Langkawi',
    accent: 'border-teal',
  },
]
